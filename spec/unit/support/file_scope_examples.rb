  ...
  describe "#compare_with" do
    ...
    it "works for differing objects" do
      ...
      expect(comparison).to eq([
        scope_class.new(extracted: true, files: Machinery::Array.new([1])),
        scope_class.new(extracted: false, files: Machinery::Array.new([3])),
        scope_class.new(files: Machinery::Array.new([2]))
      ])
    end
  end
end
